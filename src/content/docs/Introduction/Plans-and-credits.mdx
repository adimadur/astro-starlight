...
Credits are the units used in CodePup AI to generate or modify components, layouts, and code. Each AI action — such as “Generate” or “Modify” — consumes a certain number of credits.
